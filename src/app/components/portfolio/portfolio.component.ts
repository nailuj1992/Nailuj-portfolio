...
export class PortfolioComponent {
  ...
  constructor(@Inject(DOCUMENT) document: Document) {
    ...
    this.slidesOthers = [
      {
        title: this.getText("title-nfc-scan"),
        description: this.getText("description-nfc-scan"),
        url: null
      }, {
        title: this.getText("title-stock-management"),
        description: this.getText("description-stock-management"),
        url: this.env.repoStockManagementUrl
      }, {
        title: this.getText("title-portfolio"),
        description: this.getText("description-portfolio"),
        url: this.env.repoPortfolioUrl
      }, {
        title: this.getText("title-sgsst"),
        description: this.getText("description-sgsst"),
        url: this.env.repoSgSstUrl
      }, {
        title: this.getText("title-inpec"),
        description: this.getText("description-inpec"),
        url: this.env.repoInpecProjectUrl
      }, {
        title: 'LCD Pin',
        description: this.getText("description-lcd-pin"),
        url: this.env.repoLcdPinUrl
      }, {
        title: 'Cuestionario LCD',
        description: this.getText("description-lcd-questions"),
        url: this.env.repoCuestionarioLcdUrl
      }, {
        title: this.getText("title-tu-conjunto"),
        description: this.getText("description-tu-conjunto"),
        url: this.env.repoTuConjuntoUrl
      }, {
        title: this.getText("title-form"),
        description: this.getText("description-form"),
