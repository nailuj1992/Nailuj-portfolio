...
mapPhrases.set("experience-8-job", new PhraseDto("Senior Developer", "Desarrollador Senior"));
mapPhrases.set("experience-8-duration", new PhraseDto("December 2024 - Present", "Diciembre 2024 - Presente"));

mapPhrases.set("experience-7-job", new PhraseDto("Unity Developer (Volunteer)", "Desarrollador Unity (Voluntariado)"));
mapPhrases.set("experience-7-duration", new PhraseDto("April 2024 - November 2024", "Abril 2024 - Noviembre 2024"));

mapPhrases.set("experience-6-job", new PhraseDto("Senior Java Web Developer", "Desarrollador Java Web Senior"));
mapPhrases.set("experience-6-duration", new PhraseDto("January 2020 - March 2023", "Enero 2020 - Marzo 2023"));

mapPhrases.set("experience-5-job", new PhraseDto("Fullstack Java Web Developer", "Desarrollador Java Web Fullstack"));
mapPhrases.set("experience-5-duration", new PhraseDto("September 2018 - December 2019", "Septiembre 2018 - Diciembre 2019"));
...
mapPhrases.set("experience-3-job", new PhraseDto("PHP Web Developer", "Desarrollador PHP Web"));
mapPhrases.set("experience-3-duration", new PhraseDto("November 2016 - March 2017", "Noviembre 2016 - Marzo 2017"));

mapPhrases.set("experience-2-job", new PhraseDto("Java desktop Developer", "Desarrollador Java Escritorio"));
mapPhrases.set("experience-2-duration", new PhraseDto("January 2016 - July 2016", "Enero 2016 - Julio 2016"));

mapPhrases.set("experience-1-job", new PhraseDto("PHP Web Developer", "Desarrollador PHP Web"));
mapPhrases.set("experience-1-duration", new PhraseDto("June 2015 - July 2015", "Junio 2015 - Julio 2015"));
...
mapPhrases.set("study-3-title", new PhraseDto("Information Technology Diploma", "Especialización en Tecnologías de la Información"));
